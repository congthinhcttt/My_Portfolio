    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-950 px-4 text-center">
        ...
        >
          ...
          <h2 className="text-3xl font-black mb-4 text-white uppercase tracking-tight">Không tìm thấy bài viết</h2>
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <div className="flex justify-between items-center mb-16">
          <Link href="/blog" className="group inline-flex items-center gap-3 text-zinc-500 hover:text-indigo-400 transition-all">
        ...
        <FadeIn>
          ...
          {/* Author
          <div className="flex items-center gap-5 mb-20 pb-12 border-b border-zinc-900">
            <div className="w-16 h-16 rounded-[20px] bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-black text-white text-2xl shadow-xl shadow-indigo-500/20 ring-4 ring-zinc-950">
              NV
            </div>
            <div>
              <div className="text-white font-bold text-lg leading-none mb-1.5">Nguyễn Văn A</div>
              <div className="text-zinc-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                Tác giả <span className="w-1 h-1 rounded-full bg-indigo-500" /> Fullstack Developer
              </div>
            </div>
          </div> */}
          ...
          {/* ✅ Content Body (Markdown renderer) */}
